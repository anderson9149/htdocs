...
app.config(function($routeProvider) {
  ...
  // Travel App Pages
  $routeProvider.when('/', {templateUrl: 'travelAppHome.html', reloadOnSearch: false});
  $routeProvider.when('/travelAppMap', {templateUrl: 'travelAppMap.html', reloadOnSearch: false});
  $routeProvider.when('/travelAppBucketList', {templateUrl: 'travelAppBucketList.html', reloadOnSearch: false});
  $routeProvider.when('/travelAppMore', {templateUrl: 'travelAppMore.html', reloadOnSearch: false});
});
